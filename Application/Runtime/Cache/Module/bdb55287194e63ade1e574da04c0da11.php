            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if(in_array($d['name'],$has)): ?><a href="<?php echo u('uninstall',['name'=>$d['name']]);?>" type="button" class="btn btn-default btn-s-xm">卸载</a>
                                <?php else: ?>
                                    <a href="<?php echo u('install',['name'=>$d['name']]);?>" type="button" class="btn btn-success btn-s-xm">安装</a><?php endif; ?>
                            </td>
