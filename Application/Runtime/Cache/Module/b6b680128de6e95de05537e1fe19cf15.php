...
<div class="m-b-md">
    ...
    <br>
    <a href="<?php echo U('Module/keyword/set',array('mo'=>$_GET['mo']));?>" class="btn btn-primary">添加关键词</a>
</div>
<div class="row">
    <div class="col-sm-12">
                ...
                <table class="table table-bordered table-hover">
                	...
                	<tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?php echo U('Module/keyword/set',array('mo'=>$_GET['mo'],'rid'=>$d['rid']));?>" class="btn btn-default">编辑</a>
                                        <a href="<?php echo U('Module/keyword/set',array('mo'=>$_GET['mo'],'rid'=>$d['rid']));?>" class="btn btn-primary">删除</a>
                                    </div>
                                </td>
