...
<section class="vbox">
    <header class="bg-black dk header navbar navbar-fixed-top-xs">
        <div class="navbar-header aside-md">
            ...
            <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="/Public/images/logo.png" class="m-r-sm"><?php echo v('config.system.webname');?></a>
            ...
            <li class="hidden-xs">
                ...
                <section class="dropdown-menu aside-xl">
                  ...
                  <span class="pull-left thumb-sm">
                    <img src="/Public/images/avatar.jpg" alt="John said" class="img-circle">
                  </span>
            ...
            <aside class="bg-light lter b-r aside-md hidden-print hidden-xs" id="nav">
                <section class="vbox">
                    ...
                    <section class="w-f scrollable">
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                            ...
                            <nav class="nav-primary hidden-xs">
                                <ul class="nav">
                                    <li class="active">
                                        <a href="../../Application/Admin/View/index.html" class="active">
                          ...
                          <i class="fa fa-angle-up text-active"></i>
                                    ...
                                    <?php if(is_array($_modules)): $i = 0; $__LIST__ = $_modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><li>
                                            ...
                                            <ul class="nav lt">
                                                <?php if(is_array($m['actions'])): foreach($m['actions'] as $key=>$d): ?><li>
                                                ...
                                                <?php if($m['message'] == 1): ?><li>
                                                        <a href="<?php echo U('Module/keyword/lists',array('mo'=>$m['name']));?>">
                                                            <i class="fa fa-angle-right"></i>
                                                            <span>关键词设置</span>
                                                        </a>
                                                    </li><?php endif; ?>
                    ...
                    <footer class="footer lt hidden-xs b-t b-light">
                        ...
                        <div class="btn-group hidden-nav-xs">
                            <i class="fa fa-user-md"></i> 客服: <?php echo v('config.system.tel');?>
...
<div class="m-b-md">
    ...
    <a href="<?php echo site_url('button.set');?>" class="btn btn-primary">添加菜单</a>
</div>
<div class="row">
    <div class="col-sm-12">
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <?php if($d['status'] == 1): ?><a href="javascript:;" class="btn btn-info">使用中</a>
                                        <?php else: ?>
                                        <a href="<?php echo site_url('button.push',['id'=>$d['id']]);?>" class="btn btn-default">推送</a><?php endif; ?>
                                    <a href="<?php echo site_url('button.set',['id'=>$d['id']]);?>" class="btn btn-default">编辑</a>
                                </div>
                            </td>
...
<!--<script src="/Public/js/charts/easypiechart/jquery.easy-pie-chart.js"></script>-->
<!--<script src="/Public/js/charts/sparkline/jquery.sparkline.min.js"></script>-->
<!--<script src="/Public/js/charts/flot/jquery.flot.min.js"></script>-->
<!--<script src="/Public/js/charts/flot/jquery.flot.tooltip.min.js"></script>-->
<!--<script src="/Public/js/charts/flot/jquery.flot.resize.js"></script>-->
<!--<script src="/Public/js/charts/flot/jquery.flot.grow.js"></script>-->
<!--<script src="/Public/js/charts/flot/demo.js"></script>-->

<!--<script src="/Public/js/calendar/bootstrap_calendar.js"></script>-->
<!--<script src="/Public/js/calendar/demo.js"></script>-->

<!--<script src="/Public/js/sortable/jquery.sortable.js"></script>-->
...
<!--<script src="/Public/js/jvectormap/demo.js"></script>-->
