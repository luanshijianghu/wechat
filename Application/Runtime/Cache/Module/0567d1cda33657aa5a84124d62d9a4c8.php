...
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <header class="panel-heading font-bold">关键词设置</header>
            <div class="panel-body">
                <form role="form" action="" method="post">
                    <div class="form-group">
                        <label>关键词</label>
                        <input type="text" class="form-control" name="keyword" value="<?php echo ($keyword['keyword']); ?>"/>
                    </div>
                    <?php echo ($module); ?>
                    <!--<div class="form-group">-->
                        <!--<label>回复内容</label>-->
                        <!--<textarea name="content" class="form-control" rows="5" value="<?php echo ($field['content']); ?>"></textarea>-->
                    <!--</div>-->
